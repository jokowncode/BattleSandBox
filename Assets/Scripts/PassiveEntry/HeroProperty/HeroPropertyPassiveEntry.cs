...
public class HeroPropertyPassiveEntry : PassiveEntry{
    ...
    public override void Construct(Hero hero){
        hero.FighterPropertyChange(this.Property, Property, this.ModifyWay, PropertyRef.Initial, this.Value, true);
    }

    public override void Destruct(Hero hero){
        hero.FighterPropertyChange(this.Property, Property, this.ModifyWay, PropertyRef.Initial, this.Value, false);
    }
